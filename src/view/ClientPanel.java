...
public class ClientPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        onlineList.setBackground(new java.awt.Color(204, 255, 255));
        onlineList.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        ...
        jLabel4.setText("Online users in this room:");

        onlineListThisRoom.setBackground(new java.awt.Color(204, 255, 255));
        onlineListThisRoom.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
